...
import heroImage from "../../assets/images/landing-pages/d8.png";
...
function RegisterPage() {
  ...
  const heroBanner = {
    description:
      "Create an account to get started with apollo and its superior file storage/sharing experience.",
    image: heroImage,
    imageText: "do to the moon",
    // linkText: '#',
